...
namespace elemental_heroes_server.Migrations
{
    ...
    [Migration("20231027140856_HeroSkillsSlot")]
    partial class HeroSkillsSlot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("elemental_heroes_server.Models.Hero", b =>
                {
                    b.HasOne("elemental_heroes_server.Models.Skill", "SkillA")
                        .WithMany()
                        .HasForeignKey("SkillAId");

                    b.HasOne("elemental_heroes_server.Models.Skill", "SkillB")
                        .WithMany()
                        .HasForeignKey("SkillBId");

                    b.HasOne("elemental_heroes_server.Models.Skill", "SkillC")
                        .WithMany()
                        .HasForeignKey("SkillCId");
